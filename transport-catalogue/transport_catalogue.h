...
namespace transport_catalogue {
    ...
    public:
        ...
        std::unordered_map<std::pair<domain::Stop*, domain::Stop*>, int, PairHash> GetDistances();

        const std::unordered_map<std::pair<domain::Stop*, domain::Stop*>, int, PairHash>& GetDistances() const;
